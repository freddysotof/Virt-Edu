    ...
    <Box sx={{ display: "flex", justifyContent: "center", alignItems: "center", height: "140vh" }}>
      <div className={styles.header}>
        ...
        <div className={styles.assignment}>
          <img className={styles.tabla1Icon} alt="" src="/Assets/svg/Assignments/group-41.svg" />
          <div className={styles.assignmentN}>Math</div>
          
        </div>
      </div>
      <Grid container direction="column" maxWidth={1800} spacing={4}>
        {rectangulos.map((rectangulo) => (
          <Grid key={rectangulo.id} item>
            <Box
              sx={{
                width: "982px",
                height: "81px",
            ...
            >
              <Grid container alignItems="center" justifyContent="" sx={{ height: "100%" }}>
                <Grid item sx={{ mr: 3, ml:3 }}>
                  <img src={rectangulo.img} alt="" style={{ height: "40px", }} />

                </Grid>
                <Grid item>{rectangulo.text}</Grid>
                <div className={styles.prueb}>Asignacion Med Term</div>
